...
from functions import DataAnalyzer
...
with st.sidebar:
    # Title
    st.title('Muhamad Yasir Noval')

    # Logo Image
    st.image('../img/submission-logo.png')
...
state, most_common_state = function.create_state_df()
order_status, common_status = function.create_order_status()

# Title
st.header('My Ecommerce Dashboard :sparkles:')
